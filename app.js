...
function homeScreen() {
  return `
    <div style="position:relative;width:100%;background:#fff;">
      ...
      <button data-nav="transfer" style="position:absolute;top:26%;left:75%;width:25%;height:8%;background:transparent;border:none;cursor:pointer;"></button>
      <button data-nav="gov" style="position:absolute;top:34%;left:50%;width:25%;height:8%;background:transparent;border:none;cursor:pointer;"></button>
    </div>`;
}
...
function transferScreen() {
  return `
    <div style="position:relative;width:100%;background:#fff;">
      <button data-nav="home" style="position:absolute;top:3%;left:2%;width:10%;height:4%;background:transparent;border:none;cursor:pointer;z-index:10;"></button>
...
function govScreen() {
  return `
    <div style="position:relative;width:100%;background:#f5f5f7;">
      ...
      <button data-nav="idcard" style="position:absolute;top:26%;left:2%;width:46%;height:16%;background:transparent;border:none;cursor:pointer;"></button>
    </div>`;
}
